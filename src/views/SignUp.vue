                            ...
                            <form @submit.prevent="signup">
                                <div class="relative z-0 w-full mb-6 group">
                                    <input type="text" name="floating_email"
                                        ...
                                        placeholder=" " required v-model="signUpData.name" autocomplete="off"
                                        maxlength="100" />
                                ...
                                <div class="relative z-0 w-full mb-6 group">
                                    <input type="email" name="floating_email"
                                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                        placeholder=" " required v-model="signUpData.email" autocomplete="off"
                                        maxlength="50" />
                                    <label for="floating_email"
                                        class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
                                        Email
                                ...
                                <div class="relative z-0 w-full mb-6 group">
                                    <input type="password" name="floating_email"
                                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                        placeholder=" " required v-model="signUpData.password" autocomplete="off"
                                ...
                                <div class="relative z-0 w-full mb-6 group">
                                    <input type="password" name="floating_email"
                                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                        placeholder=" " required v-model="signUpData.confirmPassword" autocomplete="off"
                                        minlength="8" maxlength="14"  />
                                    <label for="floating_email"
                                        class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
                                        Confirm Password
                                ...
                                <div class="relative z-0 w-full mb-6 group">
                                    ...
                                    <label for=""
                                        ...
                                        Role</label>
                                    <select id="underline_select" required placeholder="please select user role"
